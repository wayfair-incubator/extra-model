...
As you can see, there are only 7 rows that all (essentially) repeat the same thing. The only difference is that each time the type of wood changes. This is done on purpose to demonstrate, what we think, is a unique advantage of `extra-model`: semantic grouping.
